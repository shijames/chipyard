# 1 "/scratch/james.shi/centrifuge/chipyard/generators/accel/hls_vadd_vadd/src/main/c/vadd_prj/solution1/.autopilot/db/accel.pragma.1.c"
# 1 "/scratch/james.shi/centrifuge/chipyard/generators/accel/hls_vadd_vadd/src/main/c/vadd_prj/solution1/.autopilot/db/accel.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/scratch/james.shi/centrifuge/chipyard/generators/accel/hls_vadd_vadd/src/main/c/vadd_prj/solution1/.autopilot/db/accel.pragma.1.c" 2
# 1 "accel.c"
# 1 "accel.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
