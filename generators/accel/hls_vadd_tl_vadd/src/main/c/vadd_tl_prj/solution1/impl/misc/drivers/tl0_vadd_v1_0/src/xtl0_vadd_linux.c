...
typedef struct {
    ...
    XTl0_vadd_uio_map maps[ MAX_UIO_MAPS ];
} XTl0_vadd_uio_info;

/***************** Variable Definitions **************************************/
static XTl0_vadd_uio_info uio_info;
...
static int uio_info_read_name(XTl0_vadd_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XTl0_vadd_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XTl0_vadd_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XTl0_vadd_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XTl0_vadd_Initialize(XTl0_vadd *InstancePtr, const char* InstanceName) {
	XTl0_vadd_uio_info *InfoPtr = &uio_info;
