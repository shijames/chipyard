set C_TypeInfoList {{ 
"vadd" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"a": [[],{ "pointer":  {"scalar": "int"}}] }, {"b": [[],{ "pointer":  {"scalar": "int"}}] }, {"c": [[],{ "pointer":  {"scalar": "int"}}] }, {"length": [[], {"scalar": "int"}] }],[],""]
}}
set moduleName vadd
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "a","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 15,"step" : 1}]},{"cName": "b","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "b","bundle": "control"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 15,"step" : 1}]},{"cName": "c","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "c","bundle": "control"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 15,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "length_r", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "length","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":60}, "offset_end" : {"in":67}} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vadd_gmem0_m_axi_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	vadd {
		gmem0 {Type IO LastRead 1985 FirstWrite 136}
