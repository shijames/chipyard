#include "/scratch/james.shi/centrifuge/chipyard/tools/centrifuge/scripts/sw_aux/sw_helper/mmio.h"
...
#define ACCEL_c_0 0x30
#define ACCEL_c_1 0x34
#define ACCEL_length_r_0 0x3c
uint32_t vadd(uint64_t a, uint64_t b, uint64_t c, uint32_t length_r)
{    // Disable Interrupt
    ...
    reg_write32(ACCEL_BASE + ACCEL_c_0, (uint32_t) (c));
    reg_write32(ACCEL_BASE + ACCEL_c_1, (uint32_t) (c >> 32));
